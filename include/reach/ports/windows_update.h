...
typedef void (*reach_windows_update_progress_callback)(
    void *user, reach_windows_update_progress progress);
...
typedef struct reach_windows_update_port {
    ...
    reach_result (*verify)(void *userdata,
                           ...
                           reach_windows_update_operation_result *out_result);
    reach_result (*load_pending_verification)(
        void *userdata, reach_windows_update_identity *out_updates, size_t update_capacity,
