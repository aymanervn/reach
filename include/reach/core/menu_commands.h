...
/* Menu command vocabulary shared by command producers (the dock assembles its
 * item commands, composition assembles the power menu) and the context_menu
 * capsule that displays any command list. Composition executes chosen
 * commands; the ids are stable across that boundary. */
