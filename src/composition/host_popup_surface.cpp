                                             ...
                                             float opacity)
{
    ...
    reach_render_command_buffer *commands = &host->popup_render_commands;
    ...
    if (content_commands != nullptr)
    {
        ...
        {
            result = reach_render_command_buffer_push(commands, &content_commands->commands[index]);
            if (result != REACH_OK)
            {
                return result;
            }
