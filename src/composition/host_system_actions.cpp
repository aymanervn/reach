...
/*
 * System-action translators (hotkeys + dock/QS actions -> port calls): media
 * transport, master volume, and brightness. Not input routing — the pointer
 * and keyboard dispatchers only route here.
 */
