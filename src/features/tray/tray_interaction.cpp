...
reach_tray_hit_result reach_tray_hit_test_popup(const reach_tray_model *model, reach_rect_f32 popup_bounds, int32_t x, int32_t y)
{
...
reach_tray_feature_action reach_tray_action_for_hit(const reach_tray_model *model, reach_tray_hit_result hit, reach_tray_action provider_action)
{
