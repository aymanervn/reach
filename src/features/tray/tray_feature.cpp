                            ...
                            reach_feature_tick_result *out)
{
    ...
    /* Settle: the release animation drained while nothing is pressed — pin the
     * opacity at zero and forget the feedback slot (moved from composition). */
...
const reach_feature_capsule_ops *reach_tray_capsule_ops(void)
{
    static const reach_feature_capsule_ops ops = {
        ...
        nullptr /* on_game_mode */, reach_tray_capsule_needs_frame,
