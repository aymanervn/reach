                                                  ...
                                                  reach_render_command_buffer *out_commands)
{
    ...
    /*
        Search text + caret. The rounded background above stays (it carries the
        results-attached square-bottom geometry the native EDIT never drew), so
        this textbox draws transparently — only text, placeholder, selection, and
        caret. This is the in-app replacement for the retired native EDIT control.
    */
    {
                                                   ...
                                                   reach_render_command_buffer *out_commands)
{
    ...
    /* Pull the visible results' icons from the icon service (32px, same key
       the old loader used; misses draw the kind fallback until the load lands). */
