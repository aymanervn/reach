                                             ...
                                             reach_render_command_buffer *out_commands)
{
    ...
    /* Mid-reveal the bounds can be too small for text + transport buttons
       (compute_layout leaves them empty); zero-sized text/vector-icon commands
       are draw errors, so only the backdrop/cover render until they fit. */
