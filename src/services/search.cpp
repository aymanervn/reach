...
/*
 * Search service. The worker body is a verbatim relocation of composition's
 * launcher-search thread: wait for a pending query, run it through the
 * provider port, publish the generation-tagged result set, notify.
 */
