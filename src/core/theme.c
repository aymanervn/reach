...
const reach_theme *reach_theme_default(void)
{
    static const reach_theme theme = {
        ...
        .music_widget_artist_text = {1.0f, 0.97f, 0.91f, 0.55f},
        .music_widget_artist_text_size = 9.0f,
        .music_widget_text_gap = 4.0f,
        ...
        .music_widget_width = 220.0f,
        .music_widget_left_margin = 4.0f,
        .music_widget_height_ratio = 0.85f,
