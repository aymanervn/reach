...
static float reach_theme_min(float a, float b) { return a < b ? a : b; }
...
float reach_theme_dock_corner_radius(const reach_theme *theme,
                                     float dock_height) {
...
float reach_theme_icon_box_corner_radius(const reach_theme *theme,
                                         float icon_box_size) {
  const reach_theme *actual = theme != 0 ? theme : reach_theme_default();
