...
static LRESULT CALLBACK reach_dock_reveal_edge_proc(HWND hwnd, UINT message, WPARAM wparam, LPARAM lparam)
{
...
static reach_result reach_dock_reveal_edge_set_bounds(
    reach_dock_reveal_edge *edge,
    reach_rect_f32 bounds
)
{
...
static reach_result reach_dock_reveal_edge_set_callback(
    reach_dock_reveal_edge *edge,
    reach_dock_reveal_edge_callback callback,
    void *user
)
...
reach_result reach_windows_create_dock_reveal_edge(reach_dock_reveal_edge_port *out_port)
{
    ...
    *out_port = {};
    ...
    edge->hwnd = CreateWindowExW(
        WS_EX_TOOLWINDOW | WS_EX_TOPMOST | WS_EX_NOACTIVATE | WS_EX_LAYERED,
        reach_dock_reveal_edge_class_name(),
        L"ReachDockRevealEdge",
        WS_POPUP,
        0,
        0,
        1,
