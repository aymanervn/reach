...
int main()
{
    ...
    /* Open via the capsule toggle (WINDOWS_KEY activation is declarative:
       reach_launcher_activation_events + composition's toggle hook). */
    ...
    /* Arrow navigation through the capsule event handler. */
    ...
    /* Enter yields an open-result intent while open. */
    ...
    /* Escape closes; clear-results resets selection/scroll. */
