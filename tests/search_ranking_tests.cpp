...
int main()
{
    ...
    copy_ascii(candidates[0].path, REACH_SEARCH_RESULT_PATH_CAPACITY, "C:\\Docs\\random-brave-notes.txt");
    ...
    copy_ascii(candidates[1].path, REACH_SEARCH_RESULT_PATH_CAPACITY, "C:\\Program Files\\Brave\\brave-helper.exe");
    ...
    copy_ascii(candidates[2].path, REACH_SEARCH_RESULT_PATH_CAPACITY, "C:\\Program Files\\Brave\\brave.exe");
    ...
    failed += expect(reach_search_rank_candidates(query, many, 8, REACH_SEARCH_MAX_RESULTS) == REACH_SEARCH_MAX_RESULTS);
