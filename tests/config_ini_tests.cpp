...
int main()
{
    ...
    failed += expect(snapshot->top_bar_style == REACH_CONFIG_TOP_BAR_STYLE_SPLIT);
    ...
    snapshot->top_bar_style = REACH_CONFIG_TOP_BAR_STYLE_SIMPLE;
    ...
    failed += expect(loaded->top_bar_style == REACH_CONFIG_TOP_BAR_STYLE_SIMPLE);
